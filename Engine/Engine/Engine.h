...
private:
    ...
    std::unique_ptr<diffusion::VulkanInitializer> m_initializer;
    std::unique_ptr<diffusion::ComponentInitializer> m_component_initializer;
    std::unique_ptr<diffusion::PhysicsSystem> m_physics_system;
