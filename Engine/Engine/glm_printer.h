...
inline void to_json(nlohmann::json& j, const mat3& matrix) {
    j = { { "matrix[0][0]", matrix[0][0] }, { "matrix[1][0]", matrix[1][0] }, { "matrix[2][0]", matrix[2][0] },
...
inline void from_json(const nlohmann::json& j, mat3& matrix) {
    j.at("matrix[0][0]").get_to(matrix[0][0]);
    j.at("matrix[1][0]").get_to(matrix[1][0]);
    j.at("matrix[2][0]").get_to(matrix[2][0]);
