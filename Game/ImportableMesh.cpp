...
void ImportableMesh::Draw(const vk::PipelineLayout& layout, const vk::CommandBuffer& cmd_buffer)
{
    cmd_buffer.bindDescriptorSets(vk::PipelineBindPoint::eGraphics, layout, 1, m_game_component.get_descriptor_set(), { {} });
